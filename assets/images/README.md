...
- `projects/transdimensional-home/` — `transdimensional-home-01.webp` through `20.webp` (portrait-first gallery with 1/2/3 portrait groups separated by landscapes; see `IMAGE-PROMPTS.md`).
