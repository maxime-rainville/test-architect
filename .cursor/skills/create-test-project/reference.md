...
| Portrait-first gallery + 1/2/3 portrait groups + hyphen title suffix | `projects/transdimensional-home.html` — first image portrait; landscapes separate a lone portrait, a pair, and a triple; `<title>` is `… - Test Architect` (hyphen, not em dash) |
